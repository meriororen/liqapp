//
//  MutabaahTableViewController.swift
//  liqapp
//
...
class MutabaahTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = listOfIbadahs.objectAtIndex(indexPath.row) as? String
